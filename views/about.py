...
I discuss challenges that I face in this process using Exeter NH as an example. It is very important to note that the Town staff, Select Board, and various committees are incredibly easy to work with. They are not the barrier. Entropy, regulations, laws, capitalism, culture, and other factors create the biggest challenges that we must overcome.
